    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddOpenApiDocument(c =>
            {
                ...
                c.Title = "Projecten Quinten Van Bever API";
                c.Version = "v1";
                c.Description = "API used by Quinten Van Bever for Web Applications 4";
        ...
        public void Configure(
            ...
            PostDataInitializer postDataInitializer
            )
        {
            ...
            postDataInitializer.InitializeData().Wait();
